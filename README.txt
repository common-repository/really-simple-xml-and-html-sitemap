...
You can add Sitemap on any posts, or pages using the shortcode [rsxh_sitemap] and it also generates an XML Sitemap which will be placed on site root directory. This plugin will improve SEO.

== Description ==

This WordPress Plugin has a really easy way to add a Sitemap for your pages. To show HTML Sitemap on any pages or posts, just use the shortcode [rsxh_sitemap]. You can also place <?php echo do_shortcode( '[rsxh_sitemap]' ); ?> in your templates. This will automatically generate a Sitemap for all pages, posts and custom post type (CPT) posts.
